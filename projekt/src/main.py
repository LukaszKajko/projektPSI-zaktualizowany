...
from src.api.routers.club import router as club_router
from src.api.routers.stadium import router as stadium_router
...
container.wire(modules=[
    "src.api.routers.club",
    "src.api.routers.stadium",
